...
export const FIELD_HELP: Record<InputKey, FieldHelp> = {
	...
	creditScore: { ruleId: 'credit-score', help: 'Your credit score (FICO or VantageScore, 300–850) — most banks and credit-card apps show it free. It rolls up payment history, utilization, credit age and more into the one number lenders actually pull.' },
