...
export const FIELD_HELP: Record<InputKey, FieldHelp> = {
	...
	income: { ruleId: 'income', help: 'Your annual income before tax — the baseline every other weight is measured against.' },
	assets: { ruleId: 'networth', help: 'Everything you own — savings, home, car, investments. We subtract your debt to get net worth, and net worth is what gets scored.' },
	debt: { ruleId: 'dti', help: 'Total debt you owe. It does double duty: subtracted from assets to get net worth, and scored on its own as a ratio to your income (not a raw dollar amount).' },
	...
	partnered: { ruleId: 'partnership', help: 'Whether you have a partner or spouse — partnered people show better longevity and pooled finances, though selection is at play.' },
