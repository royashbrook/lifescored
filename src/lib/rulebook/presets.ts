...
export const PRESETS: Preset[] = [
	{
		...
		inputs: {
			...
			income: 45000, assets: 30000, debt: 25000, creditScore: 700, emergencyMonths: 1, homeowner: false,
	...
	},
	{
		...
		inputs: {
			...
			smoker: 'never', exerciseMins: 60, alcohol: 'moderate', sleepHours: 7, insured: true, bmiBand: 'over',
			income: 80000, assets: 250000, debt: 120000, creditScore: 720, emergencyMonths: 1, homeowner: true,
			education: 'some', employment: 'employed', outlook: 'stable',
	...
	},
	{
		...
		inputs: {
			...
			income: 5000, assets: 5000, debt: 0, creditScore: 650, emergencyMonths: 0, homeowner: false,
	...
	},
	{
		...
		inputs: {
			...
			income: 120000, assets: 400000, debt: 0, creditScore: 810, emergencyMonths: 12, homeowner: true,
	...
	},
	{
		...
		inputs: {
			...
			income: 8000, assets: 10000, debt: 15000, creditScore: 540, emergencyMonths: 0, homeowner: false,
	...
	},
	{
		...
		inputs: {
			...
			income: 40000, assets: 30000, debt: 10000, creditScore: 710, emergencyMonths: 2, homeowner: false,
			education: 'some', employment: 'employed', outlook: 'stable',
			socialConnection: 1, partnered: false, children: 0, volunteers: false, drivingIncidents: 0, digitalFootprint: 1,
			housing: 'stable', banking: 'banked', criminalRecord: false, voterRegistered: true
		}
