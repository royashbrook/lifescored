...
<div class="mt-2 space-y-5 text-[0.9375rem] leading-relaxed" style:color="var(--ink)">
	...
	<section id="left-out" style:scroll-margin-top="1rem">
		<h2 class="mb-1 text-[1.0625rem] font-semibold" style:font-family="var(--font-display)">What's deliberately left out</h2>
		<p>
	...
	<section>
		<h2 class="mb-1 text-[1.0625rem] font-semibold" style:font-family="var(--font-display)">How the scoring works</h2>
		<p>
	...
	<section id="how-it-works" style:scroll-margin-top="1rem">
		<h2 class="mb-1 text-[1.0625rem] font-semibold" style:font-family="var(--font-display)">How this works — and what "no tracking" means</h2>
		<p>
	...
	<section>
		<h2 class="mb-1 text-[1.0625rem] font-semibold" style:font-family="var(--font-display)">Keeping it free</h2>
		<p>
	...
	<section>
		<h2 class="mb-1 text-[1.0625rem] font-semibold" style:font-family="var(--font-display)">The receipts</h2>
		<p>
